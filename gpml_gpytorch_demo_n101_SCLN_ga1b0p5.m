...
% Import the data
simplelinearlownoise = readtable("../MATLAB/data/simple_cubic_lownoise_n101.csv", opts);
...
scatter(train_x, train_y3); title("Simple cubic DGP with low noise (n=101)");

fig = figure(3);
expchain = exp(chain);
plotmatrix(expchain); title("Posterior hypers: simple cubic DGP with low noise (n=101)")
